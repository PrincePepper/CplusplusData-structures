//
// Created by Semen on 08.04.2020.
//
//Листинг #1
#include <iostream>
...
void Add(int x, List *&MyList)                          //Принимаем элемент стека и указатель на стек, при этом говорим,
                                                        // что принимаемый указатель будет сам по себе указателем
{
...
int main() {
    ...
    for (int i = 10; i > 0; --i) Add(i, MyList); //Заносим данные в стек
